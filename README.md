...
**agents**: This file provides critical context for agents working in this repository. All information here should be verified in the codebase before being used.
